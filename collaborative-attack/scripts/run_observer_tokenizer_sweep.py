...
ROOT_DIR = Path("/workspace/codes/AlienLMv2")
ATTACK_DIR = ROOT_DIR / "iclr_review" / "attack_scenario" / "n-gram_w_known-plaintext"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cache_dir", type=str, default="/workspace/data2/jaehee/AlienLM/HF_DATASET")
